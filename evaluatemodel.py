...
test_data_labelled = HerbariumSheets(download=False, train=False, root='data', transform=transform, target_transform=target_transform)
...
#[4] Train model
epochs = 50
evaluateepochs(model, instance_clustering, test_loader, 30)
